...
if [ -n "$SYNC" ] || [ -n "$CHECKOUT" ]; then
    cd llvm
    [ -z "$SYNC" ] || git fetch
    git checkout 70c796521ab5332389f6bc7fa079c3df59b276da
    cd tools/clang
    [ -z "$SYNC" ] || git fetch
    git checkout a33893a32b22f7903c0a9fa1b0454cf18b744eb2
    cd ../lld
    [ -z "$SYNC" ] || git fetch
    git checkout 64d53dc43094b63e020553b705632b603dd71816
    cd ../../..
fi
