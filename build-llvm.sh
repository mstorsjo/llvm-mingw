...
if [ -n "$SYNC" ] || [ -n "$CHECKOUT" ]; then
    cd llvm
    [ -z "$SYNC" ] || git fetch
    git checkout 17dce3bea3d23a5d20a00922725e6841e8423be5
    cd tools/clang
    [ -z "$SYNC" ] || git fetch
    git checkout 339ff47af8084b99b9968f078e66f62d6adfafab
    cd ../lld
    [ -z "$SYNC" ] || git fetch
    git checkout ba88da80b300e0723b141f5080b2ef0bbad29e4a
    cd ../../..
fi
