...
if [ -n "$SYNC" ] || [ -n "$CHECKOUT" ]; then
    cd llvm
    [ -z "$SYNC" ] || git fetch
    git checkout 9c31578d29f4882d9b17b7117cebd63b238f8c11
    cd tools/clang
    [ -z "$SYNC" ] || git fetch
    git checkout a03da8be08a208122e292016cb6cea1f30229677
    cd ../lld
    [ -z "$SYNC" ] || git fetch
    git checkout d60a0355ddea74671c3a17d8cf15142d42a6aae2
    cd ../../..
fi
